...
angular.module('myApp.controllers').controller('StudentListController', function($scope, $state, Student,toaster, Course) {
...
}).controller('StudentEditController', function($scope, $state, $stateParams, toaster, Student, Course) {
		 $scope.loading = false;
...
}).controller('StudentCreateController', function($scope, $state, Student, toaster, Course) {
